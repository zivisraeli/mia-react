...
class KitbullSection extends React.Component {
  render() {
    return (
      <section id="kitbull-section" class="middle-section">
	      <hr/>
	      ...
	      <span>Kate Schweitzer</span> / <a href="http://popsugar.com" target="_blank">popsugar</a>
      </section>
    );
  }
}

export default KitbullSection;